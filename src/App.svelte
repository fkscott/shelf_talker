<script>
	...
	import Acclaim from './Components/AcclaimTemplate.svelte';
	import NonAcclaim from './Components/NonAcclaimTemplate.svelte';
    ...
    function toggleTemplate(){
        globals.acclaim = !globals.acclaim;
    ...
    function exportShelfTalker(){
        ...
        if(globals.acclaim){
            html2canvas(document.querySelector("#acclaim-template-preview")).then(canvas =>{
                ...
                download_link.download = `${acclaim_props.name}_shelf_talker.png`;

                alert("shelf talker ready for download");

                globals.hide_download = false;
            });
        }	
            ...
            html2canvas(document.querySelector("#nonacclaim-template-preview")).then(canvas =>{
                ...
                download_link.href = canvas.toDataURL();
                download_link.download = `${non_acclaim_props.name}_shelf_talker.png`;
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div id="shelf-talker-container">
					...
					{#if globals.acclaim}
						<Acclaim props={acclaim_props}></Acclaim>	
					{:else}

						<NonAcclaim props={non_acclaim_props}></NonAcclaim>	
					{/if}
				</div>
			</div>
					...
					{#if globals.acclaim}
						...
						<!-- Start Acclaim Info Entry-->
							<div class="col-md-6">
								...
								<h4> Wine Info</h4>
								<input class="form-control form-control-lg" type="text" placeholder="Wine Name" bind:value={acclaim_props.name} aria-label="acclaim_wine_name">
								...
								<input class="form-control form-control-lg" type="text" placeholder="Type" bind:value={acclaim_props.type} aria-label="acclaim_wine_type">
				
								<input class="form-control form-control-lg" type="text" placeholder="Vintage" bind:value={acclaim_props.vintage} aria-label="acclaim_wine_vintage">
				
								<input class="form-control form-control-lg" type="text" placeholder="Region" bind:value={acclaim_props.region} aria-label="acclaim_wine_region">
				
								<input class="form-control form-control-lg" type="text" placeholder="Score" bind:value={acclaim_props.score} aria-label="acclaim_score">
				
								<select bind:value={acclaim_props.selected_source} class="form-select form-select-lg mb-3" aria-label="acclaim_source_dropdown">
								...
								<input class="form-control form-control-lg" type="text" placeholder="Custom Acclaim Source" bind:value={acclaim_props.custom_source} aria-label="acclaim_custom_source">
								
				
								<select bind:value={acclaim_props.lifestyle} class="form-select form-select-lg mb-3" aria-label="acclaim_vegan_dropdown">
								...
								<input class="form-control form-control-lg" type="text" placeholder="Price" bind:value={acclaim_props.price} aria-label="acclaim_score">
							...
							<div class="col-md-6">
								<h4>Text Entry</h4>
								<textarea class="form-control" bind:value={acclaim_props.text} placeholder="Enter Acclaim text."></textarea>
						...
						<div class="row">
							<!-- Start Non-Acclaim Info Entry-->
								<div class="col-md-6">
									...
									<h4> Wine Info</h4>
									<input class="form-control form-control-lg" type="text" placeholder="Wine Name" bind:value={non_acclaim_props.name} aria-label="non_acclaim_wine_name">
									...
									<input class="form-control form-control-lg" type="text" placeholder="Type" bind:value={non_acclaim_props.type} aria-label="non_acclaim_wine_type">
				
									<input class="form-control form-control-lg" type="text" placeholder="Vintage" bind:value={non_acclaim_props.vintage} aria-label="non_acclaim_wine_vintage">
				
									<input class="form-control form-control-lg" type="text" placeholder="Region" bind:value={non_acclaim_props.region} aria-label="non_acclaim_wine_region">
				
									<input class="form-control form-control-lg" type="text" placeholder="Price" bind:value={non_acclaim_props.price} aria-label="non_acclaim_price">
								</div>
								<!-- End Non-Acclaim Info Entry -->
								<!--start non-acclaim text-->
								<div class="col-md-6">
									<h4> Text Entry</h4>
									<textarea class="form-control" bind:value={non_acclaim_props.text} placeholder="Enter text."></textarea>
